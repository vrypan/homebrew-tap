...
<table>
  ...
  <tbody>
    <tr style="background:#ffffff;">
      ...
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>0.7.3</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>bckt is an opinionated but flexible static site generator for blogs <br><em>(Last updated: 2026-06-18)</em></small></td>
