...
<table>
  ...
  <tbody>
    ...
    <tr style="background:#ffffff;">
      ...
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Formula</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>0.2.1</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Scan histories, environment, and AI agent transcripts for secrets. <br><em>(Last updated: 2026-07-12)</em></small></td>
