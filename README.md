...
<table>
  ...
  <tbody>
    ...
    <tr style="background:#f6f8fa;">
      ...
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Formula</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>0.3.5</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Peer-to-peer folder sync for small trusted groups on a LAN. <br><em>(Last updated: 2026-08-05)</em></small></td>
