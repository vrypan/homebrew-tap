...
<table>
  ...
  <tbody>
    ...
    <tr style="background:#ffffff;">
      ...
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Formula</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>0.1.5</small></td>
      <td style="border:1px solid #d0d7de; padding:6px 12px;"><small>Scan shell history files for accidentally persisted secrets. <br><em>(Last updated: 2026-05-09)</em></small></td>
